...
### VS code settings
#### launch.json
A `launch.json` is utilised to configure the debugger in VS code.
Simply it is a debugger settings.
...
```
{
    ...
    "configurations": [
    {
      ...
      "type": "cppdbg",
      "request": "launch",
      "program": "${workspaceFolder}/output/program.exe",
      "args": [
        "-fcolor-diagnostics",
        "-fansi-escape-codes",
        "-g",
        "${workspaceFolder}/src/*.cpp",  // cpp files under src
        "-Iinclude", // header files under include
        "-o",
...
| Keyword | Description |
|--------|----------------------|
| `program`      | The path to the executable you intend to debug. |
| `args`      | Json array of command-line arguments to passs to the program when i's lauched. |
| `cwd`  | Locates te working directly of the application launched by the debugger. |

https://code.visualstudio.com/docs/cpp/launch-json-reference

#### tasks.json

It is a build instructions.
